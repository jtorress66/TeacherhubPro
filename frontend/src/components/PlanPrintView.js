      ...
      <div className="bg-white rounded-lg shadow-xl max-w-7xl w-full max-h-[95vh] overflow-auto">
        ...
        <div className="p-6 bg-slate-200">
          <div ref={printRef} className="preview-wrapper">
            ...
            <div className="bg-white shadow-lg mb-6 mx-auto" style={{ width: '11in', height: '8.5in', padding: '0.15in 0.2in', overflow: 'hidden' }}>
              <WeeklyPlanPage
                days={planDays}
                weekNum={1}
            ...
            {/* Page 3: Standards */}
            <div className="bg-white shadow-lg mx-auto" style={{ width: '11in', height: '8.5in', padding: '0.15in 0.2in', overflow: 'hidden' }}>
              <StandardsPage />
            </div>
          </div>
        </div>
