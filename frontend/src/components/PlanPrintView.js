            ...
            {days.map((day, i) => (
              <td key={i}>
                ...
                <div className="dok-item">
                  ...
                  <span style={{fontSize: '6pt', color: '#333', marginLeft: '11px'}}>(Requires some basic mental reasoning, beyond memory)</span>
                </div>
                <div className="dok-item">
                  <Chk checked={day.dok_levels?.includes(3)} /> Level 3: Strategic Thinking<br/>
                  <span style={{fontSize: '6pt', color: '#333', marginLeft: '11px'}}>(Demonstrate knowledge based on complex cognitive demand)</span>
                </div>
                <div className="dok-item">
                  <Chk checked={day.dok_levels?.includes(4)} /> Level 4: Extended Thought<br/>
                  <span style={{fontSize: '6pt', color: '#333', marginLeft: '11px'}}>(Extends knowledge to broader contexts)</span>
                </div>
              </td>
            ))}
          </tr>
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-7xl w-full max-h-[95vh] overflow-auto">
        ...
        <div className="p-6 bg-slate-200">
          <div ref={printRef} className="preview-wrapper">
            {/* Page 1: Week 1 Daily Plan - Fixed height to match print */}
            <div className="bg-white shadow-lg mb-6 mx-auto" style={{ width: '11in', height: '8.5in', padding: '0.2in', display: 'flex', flexDirection: 'column' }}>
              <WeeklyPlanPage
                days={planDays}
                weekNum={1}
            ...
            {/* Page 3: Standards */}
            <div className="bg-white shadow-lg mx-auto" style={{ width: '11in', height: '8.5in', padding: '0.2in' }}>
              <StandardsPage />
            </div>
          </div>
        </div>
